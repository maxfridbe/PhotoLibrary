...
class App {
    ...
    async removeSavedSearch(id) {
        ...
        if (this.selectedSavedSearchId === id)
    ...
    initPubSub() {
        ...
        hub.sub(ps.PHOTO_UPDATED, (data) => {
            ...
            if (flatIdx !== -1)
                this.allPhotosFlat[flatIdx] = updatedPhoto;
    ...
    renderLibrary() {
        ...
        const props = {
            ...
            onSavedSearchFilterChange: (s) => this.setSavedSearchFilter(s),
            ...
            onSavedSearchContextMenu: (e, s) => this.showSavedSearchContextMenu(e, s),
    ...
    showSavedSearchContextMenu(e, s) {
        const menu = document.getElementById('context-menu');
        menu.innerHTML = '';
        const addItem = (text, cb) => {
            const el = document.createElement('div');
