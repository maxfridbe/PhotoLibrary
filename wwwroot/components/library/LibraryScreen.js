                    ...
                    h('div', { style: { display: 'flex', flexDirection: 'column', gap: '1em' } }, [
                        h('div', { style: { display: 'flex', gap: '0.5em' } }, [
                            h('input#scan-path-input', {
                                ...
                                on: { input: (e) => onPathChange(e.target.value) }
                            }),
                            h('button', {
...
function renderFolderList(info, onPathChange) {
...
function renderImportControls(isIndexing, results, currentPath, onIndex, onCancel) {
    if (isIndexing) {
